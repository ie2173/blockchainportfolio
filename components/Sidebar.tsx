    ...
    return (
        <div id='main' className='h-full font-Questrial'>
           <div >
            ...
            <p className='px-2 py-1 my-3 bg-gray-200 rounded-full dark:bg-dark-200'>Web3 Developer </p>
            <a className='flex items-center justify-center px-2 py-1 my-3 bg-gray-200 rounded-full dark:bg-dark-200'><BsFileEarmarkPersonFill className='w-5 h-5' /> Download Resume</a>
            ...
            <div id='2' className='py-4 my-5 bg-gray-200 dark:bg-dark-200 ' style={{marginLeft:'-1rem', marginRight:'-1rem'}}>
            ...
            <div id='3'>
                ...
                <button className='w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-green to-blue-400' onClick={changeTheme}>Dark Mode</button> 
