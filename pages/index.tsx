...
const index = () => {
  return (
    <div className='flex flex-col pt-1 px-7'>
      ...
      <div className='flex-grow tracking-wide text-left bg-gray-500 p-7 mt-7' style={{marginLeft:'-2rem',marginRight:'-2rem'}}>
        <h6 className='p-2 text-xl font-bold'>Skills:</h6>
        <div className='grid gap-6 text-left md:grid-cols-2'>
        {services.map(service => (
              <div className='bg-gray-100 rounded-lg lg:col-span-1'key={service.title}>
